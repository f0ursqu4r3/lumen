...
describe('AppearancePane', () => {
  ...
  it('radius/density/font segmented controls call setOverride', async () => {
    ...
    expect(w.find('[data-test="radius-plush"]').exists()).toBe(true)
    expect(w.find('[data-test="density-airy"]').exists()).toBe(true)
    expect(w.find('[data-test="font-classic"]').exists()).toBe(true)
